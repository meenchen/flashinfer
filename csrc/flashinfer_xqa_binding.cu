...
#if MIXED_KV_CACHE
                 double kCacheScale, tvm::ffi::Optional<TensorView> kScaleTensor,
                 double vCacheScale, tvm::ffi::Optional<TensorView> vScaleTensor,
#else
                 double kvCacheScale, tvm::ffi::Optional<TensorView> kvScaleTensor,
#endif
                 int64_t qSeqLen, tvm::ffi::Optional<TensorView> mask, TensorView semaphores,
                 TensorView scratch, bool enable_pdl);
